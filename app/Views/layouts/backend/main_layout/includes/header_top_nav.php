                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="<?php echo base_url(); ?>/'assets/backend/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="<?php echo base_url(); ?>/assets/backend/images/profile/17.jpg" width="20" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="app-profile.html" class="dropdown-item ai-icon">
                                        ...
                                        <span class="ml-2">{{ Auth::guard('web')->user()->username ?? null }}</span>
                                    </a>
